...
import { analyzeTaskDependencies, canRunParallel, determineExecutionStrategy, topologicalSort, getNextExecutableTasks, createPlannerPrompt, } from './planner.js';
const createMockTask = (id, dependencies = [], status = 'pending') => ({
    id,
    description: `Task ${id}`,
    dependencies,
    status,
