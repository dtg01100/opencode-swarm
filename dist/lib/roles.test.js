...
import { DEFAULT_ROLES, getRoleDefinition, getSystemPromptForRole, getToolsForRole, buildAgentSystemPrompt, mergeCustomRoles, } from './roles.js';
describe('roles', () => {
    describe('DEFAULT_ROLES', () => {
        it('should define all required agent roles', () => {
            const expectedRoles = ['planner', 'coder', 'reviewer', 'tester', 'documenter'];
    ...
    describe('getRoleDefinition', () => {
        ...
        it('should return coder as default for unknown role', () => {
            const result = getRoleDefinition('unknown');
            expect(result.role).toBe('coder');
        });
